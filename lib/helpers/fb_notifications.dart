  ...
  static Future<void> initNotifications() async {
    ...
    if (!kIsWeb) {
      channel = const AndroidNotificationChannel(
        'styleCosmetics_notification_channel',
        'Style Cosmetics Notifications Channel',
        description: 'This channel will receive notifications specific to Style Cosmetics',
        importance: Importance.high,
        enableLights: true,
        enableVibration: true,
        ledColor: Color(0xffcd4887),
        showBadge: true,
        playSound: false,
      );
    }
